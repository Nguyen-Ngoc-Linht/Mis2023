...
(function (e) { "object" === typeof module && module.exports ? (e["default"] = e, module.exports = e) : "function" === typeof define && define.amd ? define("highcharts/modules/exporting", ["highcharts"], function (m) { e(m); e.Highcharts = m; return e; }) : e("undefined" !== typeof Highcharts ? Highcharts : void 0); })(function (e) {
    ...
    m(e, "modules/full-screen.src.js", [e["parts/Globals.js"]], function (f) {
        var g = f.addEvent, e = f.Chart, n = function () {
            ...
            g.prototype.close = function () {
                var h = this.chart;
                if (this.isOpen && this.browserProps && h.container.ownerDocument instanceof Document)
                    h.container.ownerDocument[this.browserProps.exitFullscreen]();
                this.unbindFullscreenEvent && this.unbindFullscreenEvent();
                this.isOpen = !1;
                this.setButtonText();
            };
            g.prototype.open = function () { var h = this, g = h.chart; if (h.browserProps) {
                h.unbindFullscreenEvent = f.addEvent(g.container.ownerDocument, h.browserProps.fullscreenChange, function () { h.isOpen ? (h.isOpen = !1, h.close()) : (h.isOpen = !0, h.setButtonText()); });
                if (g.container.parentNode instanceof Element) {
                    var e = g.container.parentNode[h.browserProps.requestFullscreen]();
                    if (e)
                        e["catch"](function () { alert("Full screen is not supported inside a frame."); });
                }
                f.addEvent(g, "destroy", h.unbindFullscreenEvent);
            } };
            g.prototype.setButtonText = function () { var h, g = this.chart, f = g.exportDivElements, e = g.options.exporting, n = null === (h = null === e || void 0 === e ? void 0 : e.buttons) || void 0 === h ? void 0 : h.contextButton.menuItems; h = g.options.lang; (null === e || void 0 === e ? 0 : e.menuItemDefinitions) && (null === h || void 0 === h ? 0 : h.exitFullscreen) && h.viewFullscreen && n && f && f.length && (f[n.indexOf("viewFullscreen")].innerHTML = this.isOpen ? h.exitFullscreen : e.menuItemDefinitions.viewFullscreen.text || h.viewFullscreen); };
    ...
    m(e, "mixins/navigation.js", [], function () { return { initUpdate: function (f) { f.navigation || (f.navigation = { updates: [], update: function (g, f) { this.updates.forEach(function (e) { e.update.call(e.context, g, f); }); } }); }, addUpdate: function (f, g) { g.navigation || this.initUpdate(g); g.navigation.updates.push({ update: f, context: g }); } }; });
    m(e, "modules/exporting.src.js", [e["parts/Globals.js"],
        e["parts/Utilities.js"], e["mixins/navigation.js"]], function (f, g, e) {
        var n = g.addEvent, u = g.css, h = g.createElement, m = g.discardElement, x = g.extend, I = g.find, B = g.fireEvent, J = g.isObject, p = g.merge, E = g.objectEach, q = g.pick, K = g.removeEvent, L = g.uniqueKey, w = f.defaultOptions, y = f.doc, C = f.Chart, M = f.isTouchDevice, z = f.win, G = z.navigator.userAgent, F = f.SVGRenderer, H = f.Renderer.prototype.symbols, N = /Edge\/|Trident\/|MSIE /.test(G), O = /firefox/i.test(G);
        x(w.lang, {
        ...
        f.post = function (a, b, c) { var d = h("form", p({ method: "post", action: a, enctype: "multipart/form-data" }, c), { display: "none" }, y.body); E(b, function (a, b) { h("input", { type: "hidden", name: b, value: a }, null, d); }); d.submit(); m(d); };
        ...
        x(C.prototype, {
            ...
            getSVG: function (a) {
                ...
                var d = h("div", null, { position: "absolute", top: "-9999em", width: this.chartWidth + "px", height: this.chartHeight + "px" }, y.body);
                ...
                a && ["xAxis", "yAxis", "series"].forEach(function (b) { var d = {}; a[b] && (d[b] = a[b], r.update(d)); });
                this.axes.forEach(function (a) {
                    var b = I(r.axes, function (b) { return b.options.internalKey === a.userOptions.internalKey; }), d = a.getExtremes(), c = d.userMin;
                    d = d.userMax;
                    b && ("undefined" !==
            ...
            }, moveContainers: function (a) { (this.fixedDiv ? [this.fixedDiv, this.scrollingContainer] : [this.container]).forEach(function (b) { a.appendChild(b); }); },
            beforePrint: function () {
                var a = y.body, b = this.options.exporting.printMaxWidth, c = { childNodes: a.childNodes, origDisplay: [], resetParams: void 0 };
                this.isPrinting = !0;
                ...
                var k = this, D = k.options.navigation, p = k.chartWidth, A = k.chartHeight, t = "cache-" + a, l = k[t], v = Math.max(e, f);
                if (!l) {
                    ...
                    l.hideMenu = function () { u(l, { display: "none" }); r && r.setState(0); k.openMenu = !1; u(k.renderTo, { overflow: "hidden" }); g.clearTimeout(l.hideTimer); B(k, "exportMenuHidden"); };
                    k.exportEvents.push(n(l, "mouseleave", function () { l.hideTimer = z.setTimeout(l.hideMenu, 500); }), n(l, "mouseenter", function () { g.clearTimeout(l.hideTimer); }), n(y, "mouseup", function (b) { k.pointer.inClass(b.target, a) || l.hideMenu(); }), n(l, "click", function () { k.openMenu && l.hideMenu(); }));
                    b.forEach(function (a) {
                        "string" === typeof a && (a = k.options.exporting.menuItemDefinitions[a]);
                        if (J(a, !0)) {
                            if (a.separator)
                                var b = h("hr", null, null, m);
                            else
                                b = h("li", { className: "highcharts-menu-item", onclick: function (b) { b && b.stopPropagation(); l.hideMenu(); a.onclick && a.onclick.apply(k, arguments); }, innerHTML: a.text || k.options.lang[a.textKey] }, null, m), k.styledMode || (b.onmouseover = function () {
                ...
                var b = this, c = b.renderer, d = p(b.options.navigation.buttonOptions, a), g = d.onclick, e = d.menuItems, f = d.symbolSize || 12;
                ...
                if (!1 !== d.enabled) {
                    ...
                    delete k.states;
                    g ? A = function (a) { a && a.stopPropagation(); g.call(b, a); } : e && (A = function (a) {
                        a && a.stopPropagation();
                    ...
                    if (d.symbol) {
                        var l = c.symbol(d.symbol, d.symbolX - f / 2, d.symbolY - f / 2, f, f, { width: f, height: f }).addClass("highcharts-button-symbol").attr({ zIndex: 1 }).add(t);
                ...
                a && (a.forEach(function (a, d) { a && (a.onclick = a.ontouchstart = null, f = "cache-" + a.menuClassName, b[f] && delete b[f], b.exportSVGElements[d] = a.destroy()); }), a.length = 0);
                b.exportingGroup && (b.exportingGroup.destroy(), delete b.exportingGroup);
                c && (c.forEach(function (a, d) { g.clearTimeout(a.hideTimer); K(a, "mouseleave"); b.exportDivElements[d] = a.onmouseout = a.onmouseover = a.ontouchstart = a.onclick = null; m(a); }), c.length = 0);
        ...
        C.prototype.inlineStyles = function () {
            ...
            var c = this.renderer, d = c.inlineToAttributes, f = c.inlineBlacklist, g = c.inlineWhitelist, e = c.unstyledElements, h = {}, m;
        ...
        H.menuball = function (a, b, c, d) { a = []; d = d / 3 - 2; return a = a.concat(this.circle(c - d, b, d, d), this.circle(c - d, b + d + 4, d, d), this.circle(c - d, b + 2 * (d + 4), d, d)); };
        ...
        n(C, "init", function () {
            var a = this;
            a.exporting = { update: function (b, c) { a.isDirtyExporting = !0; p(!0, a.options.exporting, b); q(c, !0) && a.redraw(); } };
