...
(function (c) { "object" === typeof module && module.exports ? (c["default"] = c, module.exports = c) : "function" === typeof define && define.amd ? define("highcharts/modules/export-data", ["highcharts", "highcharts/modules/exporting"], function (k) { c(k); c.Highcharts = k; return c; }) : c("undefined" !== typeof Highcharts ? Highcharts : void 0); })(function (c) {
    ...
    k(c, "mixins/download-url.js", [c["parts/Globals.js"]], function (b) {
        ...
        b.dataURLtoBlob = function (b) { if ((b = b.match(/data:([^;]*)(;base64)?,([0-9A-Za-z+/]+)/)) && 3 < b.length && a.atob && a.ArrayBuffer && a.Uint8Array && a.Blob && k.createObjectURL) {
        ...
        b.downloadURL = function (d, k) {
            ...
            if ("string" === typeof d || d instanceof String || !c.msSaveOrOpenBlob) {
                if (v || 2E6 < d.length)
                    if (d = b.dataURLtoBlob(d),
                        !d)
                        throw Error("Failed to convert to blob");
                if ("undefined" !== typeof e.download)
                    e.href = d, e.download = k, u.body.appendChild(e), e.click(), u.body.removeChild(e);
                else
                    try {
    ...
    k(c, "modules/export-data.src.js", [c["parts/Globals.js"], c["parts/Utilities.js"]], function (b, a) {
        function c(a, b) {
            ...
            try {
                ...
                if (!m)
                    return e.createObjectURL(new d.Blob(["\ufeff" + a], { type: b }));
            }
            catch (G) { }
        }
        ...
        b.Chart.prototype.setUpKeyToAxis = function () { e.arearange && (e.arearange.prototype.keyToAxis = { low: "y", high: "y" }); e.gantt && (e.gantt.prototype.keyToAxis = { start: "x", end: "x" }); };
        b.Chart.prototype.getDataRows = function (a) {
            var c = this.hasParallelCoordinates, d = this.time, e = this.options.exporting && this.options.exporting.csv || {}, m = this.xAxis, p = {}, f = [], B = [], w = [], r, C = function (h, c, d) { if (e.columnHeaderFormatter) {
                var g = e.columnHeaderFormatter(h, c, d);
                if (!1 !== g)
                    return g;
            } return h ? h instanceof b.Axis ? h.options.title && h.options.title.text || (h.isDatetimeAxis ? "DateTime" : "Category") : a ? { columnTitle: 1 < d ? c : h.name, topLevelColumnTitle: h.name } : h.name + (1 < d ? " (" + c + ")" : "") : "Category"; }, D = function (a, c, d) {
                var h = {}, g = {};
            ...
            this.series.forEach(function (h) {
                ...
                if (!1 !== h.options.includeInDataExport && !h.options.isInternal && !1 !== h.visible) {
                    ...
                    for (n = 0; n < q;)
                        r = C(h, t[n], t.length), w.push(r.columnTitle ||
                    ...
                    h.options.data.forEach(function (a, b) {
                        ...
                        p[a].x = g.x;
                        p[a].name = m;
                        for (p[a].xValues[k] = g.x; n < q;)
                            b = t[n], m = g[b], p[a][y + n] = v(f.categoryMap[b][m], f.dateTimeValueAxisMap[b] ? d.dateFormat(e.dateFormat, m) : null, m), n++;
                    });
                    y += n;
                }
            });
            for (q in p)
                Object.hasOwnProperty.call(p, q) && f.push(p[q]);
            var q = a ? [B, w] : [w];
            for (y = g.length; y--;) {
                var t = g[y][0];
                var l = g[y][1];
                ...
                f.forEach(function (a) {
                    var b = a.name;
                    x && !k(b) && (x.isDatetimeAxis ? (a.x instanceof Date && (a.x = a.x.getTime()), b = d.dateFormat(e.dateFormat, a.x)) : b = x.categories ? v(x.names[a.x], x.categories[a.x], a.x) : a.x);
                    a.splice(l, 0, b);
                });
            }
            q = q.concat(f);
        ...
        b.Chart.prototype.getCSV = function (a) {
            ...
            c.forEach(function (a, d) {
                for (var f, n = a.length; n--;)
                    f = a[n], "string" === typeof f && (f = '"' + f + '"'), "number" === typeof f && "." !== e && (f = f.toString().replace(".", e)), a[n] = f;
                b += a.join(m);
                d < c.length - 1 && (b +=
                    k);
            });
        ...
        b.Chart.prototype.getTable = function (a) {
            ...
            var f = 0, k = e ? a.shift() : null, m = a.shift(), w = function (a, b, c, e) { var g = v(e, ""); b = "text" + (b ? " " + b : ""); "number" === typeof g ? (g = g.toString(), "," === d && (g = g.replace(".", d)), b = "number") : e || (b = "empty"); return "<" + a + (c ? " " + c : "") + ' class="' + b + '">' + g + "</" + a + ">"; };
            ...
            b += function (a, b, d) {
                ...
                if (b) {
                    ...
                    for (d = b.length; g < d; ++g)
                        "undefined" !== typeof b[g] && (f += w("th", null, 'scope="col"', b[g]));
                    f += "</tr>";
                }
                return f + "</thead>";
            ...
            a.forEach(function (a) {
                b +=
                    "<tr>";
                for (var c = 0; c < f; c++)
                    b += w(c ? "td" : "th", null, c ? "" : 'scope="row"', a[c]);
                b += "</tr>";
            });
            b += "</tbody></table>";
            a = { html: b };
        ...
        b.Chart.prototype.downloadCSV = function () { var a = this.getCSV(!0); f(c(a, "text/csv") || "data:text/csv,\ufeff" + encodeURIComponent(a), this.getFilename() + ".csv"); };
