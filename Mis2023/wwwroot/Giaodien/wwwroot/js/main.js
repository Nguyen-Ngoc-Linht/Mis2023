...
var make_buttons = function(sheetnames, onsheet) {
...
var _selectSheet = function (sheetIndex) {


}
var _onsheet = function (json, sheetnames, sheetIndex) {
 

    make_buttons(sheetnames, _selectSheet);
  ...
  /* load data */
  cdg.data = json[sheetIndex];
  console.log(json[sheetIndex]);
};
