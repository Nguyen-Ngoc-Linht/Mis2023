...
namespace CoreLib.SharedKernel
{
    public class HttpRequestFactory
    {
        ...
        // request with role code and username
        //
        public static async Task<HttpResponseMessage> Get(string requestUri, string bearerToken, string roleCode, string username)
        {
            var builder = new HttpRequestBuilder()
                .AddMethod(HttpMethod.Get)
                .AddRequestUri(requestUri)
        ...
        public static async Task<HttpResponseMessage> Post(string requestUri, object value, string bearerToken, string roleCode, string username)
        {
            var builder = new HttpRequestBuilder()
                .AddMethod(HttpMethod.Post)
                .AddRequestUri(requestUri)
        ...
        public static async Task<HttpResponseMessage> Put(string requestUri, object value, string bearerToken, string roleCode, string username)
        {
            var builder = new HttpRequestBuilder()
                .AddMethod(HttpMethod.Put)
                .AddRequestUri(requestUri)
        ...
        public static async Task<HttpResponseMessage> Delete(string requestUri, string bearerToken, string roleCode, string username)
        {
            var builder = new HttpRequestBuilder()
                .AddMethod(HttpMethod.Delete)
                .AddRequestUri(requestUri)
